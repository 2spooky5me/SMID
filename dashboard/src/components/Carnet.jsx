...
const Carnet = (props) => {
    const doctor_info = props.doctor_info;
  return (
    <>
      <div className='h-[8.3cm] w-[5.5cm] bg-white print-view'>
        ...
        <div className='fondo-login h-[4.39cm] text-center pt-[1px]'>
          ...
          <div className='flex justify-center mb-1'>
            <img src={doctor_info.photo ? doctor_info.photo : DR} alt='Doctor' className=' h-[2.8cm] w-[2.5cm] border-2 border-orangecpv-500' />
          </div>
        ...
        <div className='h-[0.37cm] border-b-[1.5px] border-cyancpv-500 text-[10px] font-bold flex justify-between'>
          <p className='ml-2'>RIF: {doctor_info.identification_rif}-{doctor_info.rif}</p> <p className='mr-2'>C.I.: {doctor_info.identification_nature}-{doctor_info.identification}</p>
        </div>
        <div className='h-[0.92cm] flex justify-between uppercase border-b-[1.5px] border-cyancpv-500 font-bold'>
          ...
          <div className='text-orangecpv-500 text-[7px] mr-2 mt-1 leading-[9px] text-center'>
            <p>código:</p>
            <p className='font-bold text-[12px] mt-1'>{doctor_info.code}</p>
          </div>
